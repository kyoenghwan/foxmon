                        ...
                        <table className="w-full text-left border-collapse min-w-[700px]">
                            <thead>
                                <tr className="bg-[#f8f8f8] border-b border-gray-200 text-gray-600 text-[12px] font-bold">
                                    <th className="py-2.5 px-4 font-bold text-center w-[15%]">희망지역</th>
                                    <th className="py-2.5 px-4 font-bold text-center w-[40%]">인재제목</th>
                                    ...
                                    <th className="py-2.5 px-4 font-bold text-center w-[10%]">희망급여</th>
                                    <th className="py-2.5 px-4 font-bold text-center w-[10%] hidden sm:table-cell">나이</th>
                                </tr>
                            </thead>
                            <tbody>
                                {generalJobs.map((job) => (
