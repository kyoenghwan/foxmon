...
export async function GET() {
    ...
    if (!connStr) {
        return NextResponse.json({ success: false, error: 'DATABASE_URL is missing in environment variables.' });
    }
    ...
    console.log('⚡ Running raw migration SQL via server DATABASE_URL...');
    ...
    try {
        ...
        console.log('✅ Server migration SQL successfully executed!');
        return NextResponse.json({ success: true, message: 'Database successfully migrated from server side!' });
    } catch (err: any) {
