...
-- [DAEGU 하위 구/군]
('JOB_REGION', 'DAEGU_01', 'DAEGU', '중구', 1),
('JOB_REGION', 'DAEGU_02', 'DAEGU', '동구', 2),
('JOB_REGION', 'DAEGU_03', 'DAEGU', '서구', 3),
('JOB_REGION', 'DAEGU_04', 'DAEGU', '남구', 4),
('JOB_REGION', 'DAEGU_05', 'DAEGU', '북구', 5),
('JOB_REGION', 'DAEGU_06', 'DAEGU', '수성구', 6),
('JOB_REGION', 'DAEGU_07', 'DAEGU', '달서구', 7),
('JOB_REGION', 'DAEGU_08', 'DAEGU', '달성군', 8),
('JOB_REGION', 'DAEGU_09', 'DAEGU', '군위군', 9),

-- [GWANGJU 하위 구/군]
('JOB_REGION', 'GWANGJU_01', 'GWANGJU', '동구', 1),
('JOB_REGION', 'GWANGJU_02', 'GWANGJU', '서구', 2),
('JOB_REGION', 'GWANGJU_03', 'GWANGJU', '남구', 3),
('JOB_REGION', 'GWANGJU_04', 'GWANGJU', '북구', 4),
('JOB_REGION', 'GWANGJU_05', 'GWANGJU', '광산구', 5),

-- [DAEJEON 하위 구/군]
('JOB_REGION', 'DAEJEON_01', 'DAEJEON', '동구', 1),
('JOB_REGION', 'DAEJEON_02', 'DAEJEON', '중구', 2),
('JOB_REGION', 'DAEJEON_03', 'DAEJEON', '서구', 3),
('JOB_REGION', 'DAEJEON_04', 'DAEJEON', '유성구', 4),
('JOB_REGION', 'DAEJEON_05', 'DAEJEON', '대덕구', 5),

-- [ULSAN 하위 구/군]
('JOB_REGION', 'ULSAN_01', 'ULSAN', '중구', 1),
('JOB_REGION', 'ULSAN_02', 'ULSAN', '남구', 2),
('JOB_REGION', 'ULSAN_03', 'ULSAN', '동구', 3),
('JOB_REGION', 'ULSAN_04', 'ULSAN', '북구', 4),
('JOB_REGION', 'ULSAN_05', 'ULSAN', '울주군', 5),

-- [SEJONG 하위 구/군]
('JOB_REGION', 'SEJONG_01', 'SEJONG', '세종시', 1),

-- [GANGWON 하위 구/군]
('JOB_REGION', 'GANGWON_01', 'GANGWON', '춘천시', 1),
('JOB_REGION', 'GANGWON_02', 'GANGWON', '원주시', 2),
('JOB_REGION', 'GANGWON_03', 'GANGWON', '강릉시', 3),
('JOB_REGION', 'GANGWON_04', 'GANGWON', '동해시', 4),
('JOB_REGION', 'GANGWON_05', 'GANGWON', '태백시', 5),
('JOB_REGION', 'GANGWON_06', 'GANGWON', '속초시', 6),
('JOB_REGION', 'GANGWON_07', 'GANGWON', '삼척시', 7),
('JOB_REGION', 'GANGWON_08', 'GANGWON', '홍천군', 8),
('JOB_REGION', 'GANGWON_09', 'GANGWON', '횡성군', 9),
('JOB_REGION', 'GANGWON_10', 'GANGWON', '영월군', 10),
('JOB_REGION', 'GANGWON_11', 'GANGWON', '평창군', 11),
('JOB_REGION', 'GANGWON_12', 'GANGWON', '정선군', 12),
('JOB_REGION', 'GANGWON_13', 'GANGWON', '철원군', 13),
('JOB_REGION', 'GANGWON_14', 'GANGWON', '화천군', 14),
('JOB_REGION', 'GANGWON_15', 'GANGWON', '양구군', 15),
('JOB_REGION', 'GANGWON_16', 'GANGWON', '인제군', 16),
('JOB_REGION', 'GANGWON_17', 'GANGWON', '고성군', 17),
('JOB_REGION', 'GANGWON_18', 'GANGWON', '양양군', 18),

-- [CHUNGBUK 하위 구/군]
('JOB_REGION', 'CHUNGBUK_01', 'CHUNGBUK', '청주시', 1),
('JOB_REGION', 'CHUNGBUK_02', 'CHUNGBUK', '충주시', 2),
('JOB_REGION', 'CHUNGBUK_03', 'CHUNGBUK', '제천시', 3),
('JOB_REGION', 'CHUNGBUK_04', 'CHUNGBUK', '보은군', 4),
('JOB_REGION', 'CHUNGBUK_05', 'CHUNGBUK', '옥천군', 5),
('JOB_REGION', 'CHUNGBUK_06', 'CHUNGBUK', '영동군', 6),
('JOB_REGION', 'CHUNGBUK_07', 'CHUNGBUK', '증평군', 7),
('JOB_REGION', 'CHUNGBUK_08', 'CHUNGBUK', '진천군', 8),
('JOB_REGION', 'CHUNGBUK_09', 'CHUNGBUK', '괴산군', 9),
('JOB_REGION', 'CHUNGBUK_10', 'CHUNGBUK', '음성군', 10),
('JOB_REGION', 'CHUNGBUK_11', 'CHUNGBUK', '단양군', 11),

-- [CHUNGNAM 하위 구/군]
('JOB_REGION', 'CHUNGNAM_01', 'CHUNGNAM', '천안시', 1),
('JOB_REGION', 'CHUNGNAM_02', 'CHUNGNAM', '공주시', 2),
('JOB_REGION', 'CHUNGNAM_03', 'CHUNGNAM', '보령시', 3),
('JOB_REGION', 'CHUNGNAM_04', 'CHUNGNAM', '아산시', 4),
('JOB_REGION', 'CHUNGNAM_05', 'CHUNGNAM', '서산시', 5),
('JOB_REGION', 'CHUNGNAM_06', 'CHUNGNAM', '논산시', 6),
('JOB_REGION', 'CHUNGNAM_07', 'CHUNGNAM', '계룡시', 7),
('JOB_REGION', 'CHUNGNAM_08', 'CHUNGNAM', '당진시', 8),
('JOB_REGION', 'CHUNGNAM_09', 'CHUNGNAM', '금산군', 9),
('JOB_REGION', 'CHUNGNAM_10', 'CHUNGNAM', '부여군', 10),
('JOB_REGION', 'CHUNGNAM_11', 'CHUNGNAM', '서천군', 11),
('JOB_REGION', 'CHUNGNAM_12', 'CHUNGNAM', '청양군', 12),
('JOB_REGION', 'CHUNGNAM_13', 'CHUNGNAM', '홍성군', 13),
('JOB_REGION', 'CHUNGNAM_14', 'CHUNGNAM', '예산군', 14),
('JOB_REGION', 'CHUNGNAM_15', 'CHUNGNAM', '태안군', 15),

-- [JEONBUK 하위 구/군]
('JOB_REGION', 'JEONBUK_01', 'JEONBUK', '전주시', 1),
('JOB_REGION', 'JEONBUK_02', 'JEONBUK', '군산시', 2),
('JOB_REGION', 'JEONBUK_03', 'JEONBUK', '익산시', 3),
('JOB_REGION', 'JEONBUK_04', 'JEONBUK', '정읍시', 4),
('JOB_REGION', 'JEONBUK_05', 'JEONBUK', '남원시', 5),
('JOB_REGION', 'JEONBUK_06', 'JEONBUK', '김제시', 6),
('JOB_REGION', 'JEONBUK_07', 'JEONBUK', '완주군', 7),
('JOB_REGION', 'JEONBUK_08', 'JEONBUK', '진안군', 8),
('JOB_REGION', 'JEONBUK_09', 'JEONBUK', '무주군', 9),
('JOB_REGION', 'JEONBUK_10', 'JEONBUK', '장수군', 10),
('JOB_REGION', 'JEONBUK_11', 'JEONBUK', '임실군', 11),
('JOB_REGION', 'JEONBUK_12', 'JEONBUK', '순창군', 12),
('JOB_REGION', 'JEONBUK_13', 'JEONBUK', '고창군', 13),
('JOB_REGION', 'JEONBUK_14', 'JEONBUK', '부안군', 14),

-- [JEONNAM 하위 구/군]
('JOB_REGION', 'JEONNAM_01', 'JEONNAM', '목포시', 1),
('JOB_REGION', 'JEONNAM_02', 'JEONNAM', '여수시', 2),
('JOB_REGION', 'JEONNAM_03', 'JEONNAM', '순천시', 3),
('JOB_REGION', 'JEONNAM_04', 'JEONNAM', '나주시', 4),
('JOB_REGION', 'JEONNAM_05', 'JEONNAM', '광양시', 5),
('JOB_REGION', 'JEONNAM_06', 'JEONNAM', '담양군', 6),
('JOB_REGION', 'JEONNAM_07', 'JEONNAM', '곡성군', 7),
('JOB_REGION', 'JEONNAM_08', 'JEONNAM', '구례군', 8),
('JOB_REGION', 'JEONNAM_09', 'JEONNAM', '고흥군', 9),
('JOB_REGION', 'JEONNAM_10', 'JEONNAM', '보성군', 10),
('JOB_REGION', 'JEONNAM_11', 'JEONNAM', '화순군', 11),
('JOB_REGION', 'JEONNAM_12', 'JEONNAM', '장흥군', 12),
('JOB_REGION', 'JEONNAM_13', 'JEONNAM', '강진군', 13),
('JOB_REGION', 'JEONNAM_14', 'JEONNAM', '해남군', 14),
('JOB_REGION', 'JEONNAM_15', 'JEONNAM', '영암군', 15),
('JOB_REGION', 'JEONNAM_16', 'JEONNAM', '무안군', 16),
('JOB_REGION', 'JEONNAM_17', 'JEONNAM', '함평군', 17),
('JOB_REGION', 'JEONNAM_18', 'JEONNAM', '영광군', 18),
('JOB_REGION', 'JEONNAM_19', 'JEONNAM', '장성군', 19),
('JOB_REGION', 'JEONNAM_20', 'JEONNAM', '완도군', 20),
('JOB_REGION', 'JEONNAM_21', 'JEONNAM', '진도군', 21),
('JOB_REGION', 'JEONNAM_22', 'JEONNAM', '신안군', 22),

-- [GYEONGBUK 하위 구/군]
('JOB_REGION', 'GYEONGBUK_01', 'GYEONGBUK', '포항시', 1),
('JOB_REGION', 'GYEONGBUK_02', 'GYEONGBUK', '경주시', 2),
('JOB_REGION', 'GYEONGBUK_03', 'GYEONGBUK', '김천시', 3),
('JOB_REGION', 'GYEONGBUK_04', 'GYEONGBUK', '안동시', 4),
('JOB_REGION', 'GYEONGBUK_05', 'GYEONGBUK', '구미시', 5),
('JOB_REGION', 'GYEONGBUK_06', 'GYEONGBUK', '영주시', 6),
('JOB_REGION', 'GYEONGBUK_07', 'GYEONGBUK', '영천시', 7),
('JOB_REGION', 'GYEONGBUK_08', 'GYEONGBUK', '상주시', 8),
('JOB_REGION', 'GYEONGBUK_09', 'GYEONGBUK', '문경시', 9),
('JOB_REGION', 'GYEONGBUK_10', 'GYEONGBUK', '경산시', 10),
('JOB_REGION', 'GYEONGBUK_11', 'GYEONGBUK', '의성군', 11),
('JOB_REGION', 'GYEONGBUK_12', 'GYEONGBUK', '청송군', 12),
('JOB_REGION', 'GYEONGBUK_13', 'GYEONGBUK', '영양군', 13),
('JOB_REGION', 'GYEONGBUK_14', 'GYEONGBUK', '영덕군', 14),
('JOB_REGION', 'GYEONGBUK_15', 'GYEONGBUK', '청도군', 15),
('JOB_REGION', 'GYEONGBUK_16', 'GYEONGBUK', '고령군', 16),
('JOB_REGION', 'GYEONGBUK_17', 'GYEONGBUK', '성주군', 17),
('JOB_REGION', 'GYEONGBUK_18', 'GYEONGBUK', '칠곡군', 18),
('JOB_REGION', 'GYEONGBUK_19', 'GYEONGBUK', '예천군', 19),
('JOB_REGION', 'GYEONGBUK_20', 'GYEONGBUK', '봉화군', 20),
('JOB_REGION', 'GYEONGBUK_21', 'GYEONGBUK', '울진군', 21),
('JOB_REGION', 'GYEONGBUK_22', 'GYEONGBUK', '울릉군', 22),

-- [GYEONGNAM 하위 구/군]
('JOB_REGION', 'GYEONGNAM_01', 'GYEONGNAM', '창원시', 1),
('JOB_REGION', 'GYEONGNAM_02', 'GYEONGNAM', '진주시', 2),
('JOB_REGION', 'GYEONGNAM_03', 'GYEONGNAM', '통영시', 3),
('JOB_REGION', 'GYEONGNAM_04', 'GYEONGNAM', '사천시', 4),
('JOB_REGION', 'GYEONGNAM_05', 'GYEONGNAM', '김해시', 5),
('JOB_REGION', 'GYEONGNAM_06', 'GYEONGNAM', '밀양시', 6),
('JOB_REGION', 'GYEONGNAM_07', 'GYEONGNAM', '거제시', 7),
('JOB_REGION', 'GYEONGNAM_08', 'GYEONGNAM', '양산시', 8),
('JOB_REGION', 'GYEONGNAM_09', 'GYEONGNAM', '의령군', 9),
('JOB_REGION', 'GYEONGNAM_10', 'GYEONGNAM', '함안군', 10),
('JOB_REGION', 'GYEONGNAM_11', 'GYEONGNAM', '창녕군', 11),
('JOB_REGION', 'GYEONGNAM_12', 'GYEONGNAM', '고성군', 12),
('JOB_REGION', 'GYEONGNAM_13', 'GYEONGNAM', '남해군', 13),
('JOB_REGION', 'GYEONGNAM_14', 'GYEONGNAM', '하동군', 14),
('JOB_REGION', 'GYEONGNAM_15', 'GYEONGNAM', '산청군', 15),
('JOB_REGION', 'GYEONGNAM_16', 'GYEONGNAM', '함양군', 16),
('JOB_REGION', 'GYEONGNAM_17', 'GYEONGNAM', '거창군', 17),
('JOB_REGION', 'GYEONGNAM_18', 'GYEONGNAM', '합천군', 18),

-- [JEJU 하위 구/군]
('JOB_REGION', 'JEJU_01', 'JEJU', '제주시', 1),
('JOB_REGION', 'JEJU_02', 'JEJU', '서귀포시', 2)
