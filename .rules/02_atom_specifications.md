...
> 현행 기준은 AGENTS.md와 foxmon-atom-design 스킬이다. 아래 일률적인 rollbackData·역순 보상·authContext 요구보다 실제 DB 트랜잭션 및 기존 인증 계약을 우선한다. RA 순수성, QA 읽기, OA 쓰기, FA 상태 격리는 유지한다. 템플릿의 전체 입력 로그와 승인 대기 절차는 복제하지 않는다.
