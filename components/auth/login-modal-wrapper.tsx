    ...
    <Dialog open={true} onOpenChange={(open) => {
      ...
      >
         ...
         <div className="relative w-full overflow-hidden bg-white rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.2)] flex flex-col">
            <button 
                onClick={() => router.back()}
                className="absolute top-6 right-6 z-50 px-3.5 py-1.5 bg-gray-100 hover:bg-gray-200 active:scale-95 text-gray-700 hover:text-gray-900 rounded-xl text-[12px] font-black transition-all shrink-0 shadow-sm border border-gray-100"
            >
                닫기
            </button>
