    ...
    return (
        <header className="bg-white border-b z-50 relative">
            ...
            <div className="bg-gray-50 border-b border-gray-100">
                <div className="w-full mx-auto px-4 min-[600px]:max-w-[649px] min-[830px]:max-w-[860px] min-[1040px]:max-w-[1071px] h-9 flex items-center justify-between text-[11px] sm:text-xs font-bold text-gray-500 overflow-x-auto scrollbar-hide whitespace-nowrap">
            ...
            <div className="w-full mx-auto px-4 min-[600px]:max-w-[649px] min-[830px]:max-w-[860px] min-[1040px]:max-w-[1071px] py-3 md:py-4">
            ...
            <div className="border-t border-gray-100 bg-white">
                <div className="w-full mx-auto px-4 min-[600px]:max-w-[649px] min-[830px]:max-w-[860px] min-[1040px]:max-w-[1071px]">
                ...
                >
                    <div className="container mx-auto px-4 lg:px-8 py-8 grid grid-cols-4 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 gap-y-3 text-[14px] font-medium text-gray-600">
                                <Link href="/help/inquiry" onClick={() => setShowMegaMenu(false)} className="hover:text-primary transition-colors">질문답변</Link>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        ...
                        <div className="px-4 py-2">
                            ...
                            <div className="border-b border-gray-100">
                                ...
                                {mobileExpanded === 'help' && (
                                    <div className="flex flex-col gap-3 pb-4 px-2 text-sm font-medium text-gray-600">
                                        <Link href="/help/inquiry" onClick={() => setShowMobileMenu(false)}>질문답변</Link>
