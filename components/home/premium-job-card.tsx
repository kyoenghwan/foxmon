                            ...
                            <div className="flex-1 flex flex-col justify-between py-1">
                                ...
                                <div className="w-full relative overflow-hidden flex items-center gap-1">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <MarqueeText className={`text-[12px] sm:text-[13px] lg:text-[14px] max-[424px]:text-[2.8vw] leading-[1.3] font-bold tracking-tight px-1 rounded-[2px] ${isCyber ? 'text-yellow-300 border-l-2 border-yellow-300 pl-1' : isImpact ? `${config.color.replace('text-', 'text-')} ${config.bg}/5` : 'text-gray-800 bg-green-200/50'}`}>
                                            {title}
                                        </MarqueeText>
                                    </div>
                                </div>
                        ...
                        <>
                            ...
                            <div className="flex-1 w-full flex flex-col justify-center relative overflow-hidden py-0.5 my-0.5">
                                <div className="w-full flex items-center gap-1.5">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <MarqueeText className={`text-[12px] sm:text-[13px] lg:text-[14px] max-[424px]:text-[2.8vw] leading-[1.3] font-bold tracking-tight px-1 rounded-[2px] ${
