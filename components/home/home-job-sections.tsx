    ...
    return (
        <main className="container px-4 md:px-6 py-12 space-y-12">
            ...
            <section>
                ...
                {demoJobs.length > 0 ? (
                    <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 gap-2 sm:gap-3 md:gap-4 w-full
            ...
            <section>
                ...
                {specialJobs.length > 0 ? (
                    <div className={`grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 gap-2 sm:gap-3 md:gap-4 w-full grid-flow-dense
                        [&>*:nth-child(n+21)]:hidden 
                        sm:[&>*:nth-child(n+21)]:block sm:[&>*:nth-child(n+31)]:hidden 
                        md:[&>*:nth-child(n+31)]:block md:[&>*:nth-child(n+41)]:hidden 
                        2xl:[&>*:nth-child(n+41)]:block 2xl:[&>*:nth-child(n+51)]:hidden 
