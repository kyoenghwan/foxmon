        ...
        <main className="container px-4 md:px-6 py-6 md:py-8 space-y-8 md:space-y-10">
                    ...
                    <div className="grid grid-cols-2 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-8 gap-2 sm:gap-4 w-full">
                        {demoJobs.map((job, idx) => (
                            <div 
                                key={job.id} 
                                className={`w-full ${
                                    !showAllPremium && idx >= 20 ? 'hidden xs:block' : ''
                                } ${
                                    !showAllPremium && idx >= 30 ? 'xs:hidden md:block' : ''
                                } ${
            ...
            <section>
                ...
                {specialJobs.length > 0 ? (
                    <div className="grid grid-cols-2 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-8 gap-1.5 sm:gap-4 w-full">
                        {specialJobs.map((job, idx) => (
                            <div 
                                key={job.id} 
                                className={`w-full ${
                                    !showAllSpecial && idx >= 20 ? 'hidden xs:block' : ''
                                } ${
                                    !showAllSpecial && idx >= 30 ? 'xs:hidden md:block' : ''
                                } ${
                    ...
                    <div className="grid grid-cols-2 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6 4xl:grid-cols-8 gap-1.5 sm:gap-4 w-full">
                        {lineJobs.map((job, idx) => (
                            <div 
                                key={job.id} 
                                className={`w-full ${
                                    !showAllGeneral && idx >= 20 ? 'hidden xs:block' : ''
                                } ${
                                    !showAllGeneral && idx >= 30 ? 'xs:hidden md:block' : ''
                                } ${
