...
export function HomeJobSections({ initialData }: HomeJobSectionsProps) {
    ...
    return (
        <main className="w-full xl:max-w-[1280px] xl:mx-auto px-4 lg:px-6 py-6 md:py-8 space-y-8 md:space-y-10">
            ...
            <section>
                ...
                {demoJobs.length > 0 ? (
                    <div className="grid grid-cols-2 min-[600px]:grid-cols-3 min-[800px]:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5 gap-2 lg:gap-4 w-fit mx-auto">
