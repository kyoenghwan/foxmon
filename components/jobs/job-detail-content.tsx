    ...
    <div className="flex flex-col min-h-full bg-white relative">
      ...
      <div className="flex-1 overflow-y-auto pb-32 md:pb-12 bg-gray-50/50">
        ...
        <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm shrink-0">
            <div className="max-w-[1100px] mx-auto p-4 md:p-6 lg:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                
                {/* 1-1. 좌측 로고 및 통계 */}
                <div className="w-full md:w-[280px] shrink-0 flex flex-col items-center">
                    <div className="w-full aspect-[3/2] bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl border border-gray-200/50 flex flex-col items-center justify-center mb-4 shadow-sm relative overflow-hidden group">
                ...
                {/* 1-2. 우측 모던 연락처 카드 및 지원 버튼 (이전 사이드바) */}
                <div className="w-full flex-1 flex flex-col xl:flex-row gap-4 xl:gap-6 justify-center">
                    {/* 프로필 정보 */}
                    <div className="bg-gray-50/80 border border-gray-100 rounded-[24px] p-5 flex items-center gap-5 shadow-sm min-w-[280px]">
                        <div className="w-16 h-16 bg-white rounded-full p-1 shadow-sm shrink-0 relative">
                            <div className="w-full h-full rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center text-3xl">🦊</div>
                            <div className="absolute bottom-0 right-0 w-4 h-4 bg-green-500 border-2 border-white rounded-full"></div>
                        </div>
                        <div>
                            <div className="bg-primary/10 text-primary text-[10px] font-black px-2 py-0.5 rounded-full inline-block mb-1.5">담당 매니저</div>
                            <h3 className="font-black text-gray-900 text-[17px] mb-0.5">{contact.manager}</h3>
                            <p className="text-[12px] text-gray-500 font-medium tracking-tight">친절하고 편안하게 상담해 드립니다.</p>
                        </div>
                    </div>
                    
                    {/* 버튼 묶음 1 (카톡/전화) */}
                    <div className="flex flex-col gap-2.5 flex-1 justify-center min-w-[200px]">
                        <Button 
                            onClick={() => {
                            ...
                            className="w-full h-[46px] rounded-xl bg-[#FEE500] hover:bg-[#F4DC00] text-[#000000] font-black text-[14px] shadow-sm flex items-center justify-center gap-2 transition-transform active:scale-95"
                        >
                            <span className="text-lg">💬</span> 카카오톡으로 지원
                        </Button>
                        <Button 
                            onClick={() => {
                            ...
                            variant="outline" 
                            className="w-full h-[46px] rounded-xl border-gray-200 text-gray-700 hover:bg-gray-50 font-bold text-[13px] shadow-sm flex items-center justify-center gap-2 transition-transform active:scale-95"
                        >
                    ...
                    <div 
                        ...
                        className="min-w-[200px] flex-1 bg-gradient-to-br from-gray-900 to-black rounded-[20px] p-4 text-white shadow-xl flex flex-col items-center justify-center group cursor-pointer hover:scale-[1.02] transition-transform"
                    >
                        ...
                        <span className="text-[12px] text-gray-400 font-medium leading-tight text-center">번호 노출 없이 안전하게<br/>1:1 익명 채팅 시작</span>
                    </div>
                </div>
            </div>
        </div>
