...
export default auth((req) => {
    ...
    // 2. Age Gate Check (Redirect all unverified users to /age-gate EXCEPT if they are trying to register, login, or access SEO/home/public pages)
    if (!isAgeVerified && !isAgeGatePage && !isRegisterPage && !isLoginPage && !isSeoPath && !isPublicStatic && !isAdminPath && !isHomePage) {
