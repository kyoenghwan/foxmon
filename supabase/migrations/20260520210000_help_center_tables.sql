...
SELECT * FROM (VALUES
    ...
    ('포인트·결제', '포인트 환불은 가능한가요?', '유료 포인트(실결제 포인트)에 한해 환불이 가능합니다. 충전 후 포인트를 단 1P도 사용하지 않은 ''미사용 충전 건''은 수수료 없이 100% 전액 환불되며, 일부라도 사용한 충전 건에 한해서만 어뷰징 방지를 위해 10%의 환불 수수료를 공제한 잔액이 환불됩니다. (보너스로 지급된 적립 포인트는 환불 대상이 아니며 전액 소멸됩니다.)', 5),
    ('포인트·결제', '등급(우수/으뜸/명가)은 어떤 혜택이 있나요?', '등급별로 포인트 충전 시 추가 보너스가 지급됩니다. 우수 등급은 10%, 으뜸 등급은 20%, 명가 등급은 30%의 보너스 적립율이 적용됩니다.', 6),
